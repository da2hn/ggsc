	...
	<h2 class="h2-title"><i class="fa fa-check-square"></i>연계의뢰서관리</h2>
		...
		<form name="searchForm" id="searchForm" action="/linkageReqList.do" method="get" onsubmit="return false">
			...
			<div class="search-box">
				...
				<div class="search-group" style="margin-left:70px;">
					<span class="label">의뢰일</span> <input type="text" name="schStartDate" id="datepicker1" value="${vo.schStartDate }" style="width: 100px;" readOnly/> &nbsp;&nbsp;&nbsp; ~ &nbsp;<input type="text" name="schEndDate" id="datepicker2" value="${vo.schEndDate}" style="width: 100px;" readOnly/>
				</div>
			</div>
		</form>
			<div>
