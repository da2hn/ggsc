...
<body>
    <div class="doc-wrap">
        <div class="doc-box mt20">
            ...
            <div class="box-title noto700 txt-center mt15 mb15">불안 척도(특성불안)</div>
            ...
            <div class="txt mt15">
               	※ 자신을 가장 잘 나타낸다고 생각되는 정도에 ‘√’표해 주십시오.
            </div>
            <table class="tbl2 mt15">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">약간<br>그렇다</th>
                        <th scope="col">보통<br>그렇다</th>
                        <th scope="col" class="bRight-none">아주<br>그렇다</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bBottom2">
                        <td class="bRight-none">*1.</td>
                        <td class="txt-left">나는 기분이 좋다.</td>
                       ...
                       <td class="bRight-none"><input type="radio" class="ascBtn4" id="no14" name="no1" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">2.</td>
                        <td class="txt-left">나는 쉽게 피로해진다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no24" name="no2" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">3.</td>
                        <td class="txt-left">나는 울고 싶은 심정이다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4"id="no34" name="no3" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">4.</td>
                        <td class="txt-left">나는 다른 사람처럼 행복했으면 좋겠다.</td>
                        <td><input type="radio" class="radBtn" id="no41" name="no4" value="1" /></td>
                        <td><input type="radio" class="radBtn2" id="no42" name="no4" value="2" /></td>
                        <td><input type="radio" class="radBtn3" id="no43" name="no4" value="3" /></td>
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no44" name="no4" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">5.</td>
                        <td class="txt-left">나는 마음을 빨리 정하지 못하여 실패를 한다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no54" name="no5" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">*6.</td>
                        <td class="txt-left">나는 마음이 놓인다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no64" name="no6" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">*7.</td>
                        <td class="txt-left">나는 차분하고 침착하다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no74" name="no7" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">8.</td>
                        <td class="txt-left">나는 너무 어려운 문제가 밀려 닥쳐서 극복할 수 없을 것 같다.</td>
                        <td><input type="radio" class="radBtn" id="no81" name="no8" value="1" /></td>
                        <td><input type="radio" class="radBtn2" id="no82" name="no8" value="2" /></td>
                        <td><input type="radio" class="radBtn3" id="no83" name="no8" value="3" /></td>
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no84" name="no8" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">9.</td>
                        <td class="txt-left">나는 하찮은 일에 너무 걱정을 많이 한다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no94" name="no9" value="4" /></td>
                    </tr>
                    <tr class="bBottom">
                        <td class="bRight-none">*10.</td>
                        <td class="txt-left">나는 행복하다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no104" name="no10" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">11.</td>
                        <td class="txt-left">나는 무슨 일이건 힘들게 생각한다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no114" name="no11" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">12.</td>
                        <td class="txt-left">나는 자신감이 부족하다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no124" name="no12" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">*13.</td>
                        <td class="txt-left">나는 마음이 든든하다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no134" name="no13" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">14.</td>
                        <td class="txt-left">나는 위기나 어려움을 피하려고 애쓴다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no144" name="no14" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">15.</td>
                        <td class="txt-left">나는 울적하다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no154" name="no15" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">*16.</td>
                        <td class="txt-left">나는 만족스럽다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no164" name="no16" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">17.</td>
                        <td class="txt-left">사소한 생각이 나를 괴롭힌다.</td>
                        ...
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no174" name="no17" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">18.</td>
                        <td class="txt-left">나는 실망을 지나치게 예민하게 받아들이기 때문에 머릿속에서 지워버릴 수가 없다.</td>
                        <td><input type="radio" class="radBtn" id="no181" name="no18" value="1" /></td>
                        <td><input type="radio" class="radBtn2" id="no182" name="no18" value="2" /></td>
                        <td><input type="radio" class="radBtn3" id="no183" name="no18" value="3" /></td>
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no184" name="no18" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">*19.</td>
                        <td class="txt-left">나는 착실한 사람이다.</td>
                        <td><input type="radio" class="ascBtn" id="no191" name="no19" value="1" /></td>
                        <td><input type="radio" class="ascBtn2" id="no192" name="no19" value="2" /></td>
                        <td><input type="radio" class="ascBtn3" id="no193" name="no19" value="3" /></td>
                        <td class="bRight-none"><input type="radio" class="ascBtn4" id="no194" name="no19" value="4" /></td>
                    </tr>
                    <tr class="bBottom2">
                        <td class="bRight-none">20.</td>
                        <td class="txt-left">나는 요즘에 걱정거리나 관심거리를 생각만 하면 긴장되거나 어찌할 바를 모른다.</td>
                        <td><input type="radio" class="radBtn" id="no201" name="no20" value="1" /></td>
                        <td><input type="radio" class="radBtn2" id="no202" name="no20" value="2" /></td>
                        <td><input type="radio" class="radBtn3" id="no203" name="no20" value="3" /></td>
                        <td class="bRight-none"><input type="radio" class="radBtn4" id="no204" name="no20" value="4" /></td>
                    </tr>
                     <tr class="bBottom2">
                        <td class="bRight-none">채점</td>
                        <td>※ 1, 6, 7, 10, 13, 16, 19 역채점 문항</td>
                        <td><input type="text" class="inp num1" id="cnt1" name="no21" readonly></td>
                        <td><input type="text" class="inp num2" id="cnt2" name="no22" readonly></td>
                        <td><input type="text" class="inp num3" id="cnt3" name="no23" readonly></td>
                        <td class="bRight-none"><input type="text" class="inp num4" id="cnt4" name="no24" readonly></td>
                    </tr>
                    <tr class="bBottom">
                        <td class="bRight-none">합계</td>
                        <td>
                        	54점 - 58점 : 특성불안 수준이 약간 높음
							<br/>59점 - 63점 : 특성불안 수준이 상당히 높음
							<br/>64점 이상 : 특성불안 수준이 매우 높음
						</td>
                        <td colspan="4" class="bRight-none"><input class="inp num2" name="no25" id="sumCnt" readonly></td>
                    </tr>
                </tbody>
            </table>
            </form>
            <div class="box-title noto700 txt-center mt15 mb15">
		     	<span class="fs20">출처: Spielberger 외에 의해 개발된 상태·특성 불안검사(State-TraitAnxiety Inventory; STAI-X)(1970)를 한덕웅, 이창호, 탁진국이 한국어판 척도로 표준화한 것(1993)</span>
		     </div>
...
<script>
$(".radBtn, .radBtn2, .radBtn3, .radBtn4, .ascBtn, .ascBtn2, .ascBtn3, .ascBtn4").change(function(e) {
	var a= $(".radBtn:checked").length, b= $(".radBtn2:checked").length*2, c= $(".radBtn3:checked").length*3, d= $(".radBtn4:checked").length*4; 
	var f= $(".ascBtn:checked").length*4, g=$(".ascBtn2:checked").length*3, h= $(".ascBtn3:checked").length*2, i = $(".ascBtn4:checked").length;
	$("#cnt1").val(a+f);
	$("#cnt2").val(b+g);
	$("#cnt3").val(c+h);
	$("#cnt4").val(d+i);
	$("#sumCnt").val(a+b+c+d+f+g+h+i);
});
</script>
