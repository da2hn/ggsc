...
public class LoginController {
	...
	@RequestMapping(value = "/login/login2.do", method = {RequestMethod.GET , RequestMethod.POST})
	public String loginUsrView2(@ModelAttribute("loginVO") EgovMap loginVO, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) {
		/*session.invalidate();*/
		return "login/login2";
	}
	...
	@RequestMapping(value = "/login/actionLogin2.do", method = {RequestMethod.GET , RequestMethod.POST})
	public String actionLogin2(HttpServletRequest request, HttpServletResponse response, ModelMap model) {

				return "main/main2.main";
	}
