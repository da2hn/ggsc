...
public class GcnsVO extends PageVO {
	...
	public String toString() {
		return "GcnsVO [num=" + num + ", caseNo=" + caseNo + ", cnsGb=" + cnsGb + ", cnsDtlGbCd=" + cnsDtlGbCd
				...
				+ ", cnsleNm=" + cnsleNm + ", pgrmCd=" + pgrmCd + ", pgrmNm=" + pgrmNm + ", authCd=" + authCd
				+ ", cnsType=" + cnsType + ", birthDt=" + birthDt + ", olderRel=" + olderRel + ", sigunCd=" + sigunCd
				+ ", clearYn=" + clearYn + ", cnsrId=" + cnsrId + ", cnsCnt=" + cnsCnt + ", atvyTitle=" + atvyTitle
				+ ", atvyDt=" + atvyDt + ", atvyStrtHour=" + atvyStrtHour + ", atvyStrtMin=" + atvyStrtMin
				+ ", atvyEndHour=" + atvyEndHour + ", atvyEndMin=" + atvyEndMin + ", atvyTotMin=" + atvyTotMin
				+ ", atvyPlace=" + atvyPlace + ", leader=" + leader + ", leaderGb=" + leaderGb + ", cnsMethd="
				+ cnsMethd + ", anchor=" + anchor + ", inputNm=" + inputNm + ", atdeCnt=" + atdeCnt + ", atdeNm="
				+ atdeNm + ", atdeId=" + atdeId + ", oriAtdeId=" + oriAtdeId + ", oriAtdeNm=" + oriAtdeNm
				+ ", atvyGoal=" + atvyGoal + ", pgrmCntn=" + pgrmCntn + ", evat=" + evat + ", afterPlan=" + afterPlan
				+ ", etc=" + etc + ", cnsrNm=" + cnsrNm + ", majorApplCd=" + majorApplCd + ", regId=" + regId
				+ ", psycQust=" + psycQust + ", perRelQust=" + perRelQust + ", psng=" + psng + ", dmta=" + dmta
				+ ", dsm=" + dsm + ", helthQust=" + helthQust + ", sungQust=" + sungQust + ", econoQust=" + econoQust
				+ ", lifeQust=" + lifeQust + ", coupleQust=" + coupleQust + ", familyQust=" + familyQust + ", partQust="
				+ partQust + ", etcQust=" + etcQust + ", fileNm=" + fileNm + ", sysFileNm=" + sysFileNm + ", filePath="
				+ filePath + ", fileDesc=" + fileDesc + ", fileSize=" + fileSize + ", schCnsGb=" + schCnsGb
				+ ", schCenterGb=" + schCenterGb + ", schPgrmNm=" + schPgrmNm + ", schLeaderNm=" + schLeaderNm
				+ ", schCnsleNm=" + schCnsleNm + ", schStartDate=" + schStartDate + ", schEndDate=" + schEndDate + "]";
	}
