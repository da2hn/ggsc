...
public class CounselMngController {
	...
	*/
	...
	@RequestMapping(value= "/majorApplDetailList_ajax.do", method = RequestMethod.POST )
	public String majorApplDetailList_ajax(HttpServletRequest request, GroupVO vo, ModelMap model) {
		
		List<EgovMap> list = adminManageService.getGroupMngDtlSList(vo);
...
/*		EgovMap map = (EgovMap) request.getSession().getAttribute("LoginVO");
	...
	// 심리 검사 PROCESS
	@RequestMapping(value = "/psyCnsDocDel.do", method = RequestMethod.POST)
	public String psyCnsDocDel(PsyCnsDocVO vo, HttpServletRequest request, ModelMap model) {
		EgovMap login = (EgovMap) request.getSession().getAttribute("LoginVO");
		...
		counselMngService.deletePsyCnsDoc(vo);
		msg = "삭제가 완료 됐습니다.";
